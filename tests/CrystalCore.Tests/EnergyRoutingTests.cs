...
public class EnergyRoutingTests
{
    ...
    public void Chain_TollsLocally_AndDeliversExitEnergy()
    {
        ...
        var lat = new Lattice();
        var a = lat.Place(0, 0, CrystalKind.Ruby);       // ▲ leaf input  → source
    ...
    {
        var lat = new Lattice();
        var a = lat.Place(0, 0, CrystalKind.Ruby);
        var b = lat.Place(0, 1, CrystalKind.Sapphire);
    ...
    public void Split_DividesPostTollEnergy()
    {
        ...
        var lat = new Lattice();
        var a = lat.Place(0, 2, CrystalKind.Ruby);       // ▲ split, cost 1
        var b = lat.Place(0, 1, CrystalKind.Sapphire);   // ▽ sink, cost 2
        var c = lat.Place(0, 3, CrystalKind.Emerald);    // ▽ sink, cost 3
    ...
    public void Debt_FlowsUnclamped_AndAMergeRecoversIt()
    {
        ...
        var lat = new Lattice();
        var left = lat.Place(0, 0, CrystalKind.Ruby);      // ▲ source, cost 12
        var right = lat.Place(0, 2, CrystalKind.Emerald);  // ▲ source, cost 2
        var merge = lat.Place(0, 1, CrystalKind.Sapphire); // ▽ sink,   cost 1
